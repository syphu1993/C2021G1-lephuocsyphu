...
<div style="width: 40%; margin-left: 30%;border: 1px solid black">
    ...
    <form method="post" style="padding: 3%">
        ...
        <div>
            ...
            <div class="form-group">
                <label>Collor</label>
                <input type="text" name="collor" class="form-control" required>
            </div>
            <div class="form-group">
                <label>Decription</label>
                <input type="text" name="decrip" class="form-control" required>
        ...
        <div>
            <a href="/product"><input type="button" class="btn btn-danger w-25" value="Cancel"></a>
