...
<header class="position-fixed w-100" style="top: 0">
    ...
    <nav class="navbar navbar-expand-sm bg-dark navbar-dark align-self-end justify-content-between">
        ...
        <form class="form-inline" action="/product?action=search" method="post">
        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    ...
                    <div class="col-sm-2">
                        <a href="/product?action=create" class="btn btn-success"><i class="material-icons"></i> <span>Add New Product</span></a>
                    </div>
                </div>
            </div>
            <table class="table table-striped table-hover" id="tableCustomer" style="width: 100%">
                ...
                <c:forEach var="product" items="${products}" varStatus="no">
                    <tr>
                        ...
                        <td><c:out value="${product.collor}"/></td>
                        <td><c:out value="${product.catelogy}"/></td>
                        <td>
                            <a href="/product?action=edit&id=${product.id}" class="edit"><button class="material-icons bg-success" data-original-title="Edit">Edit</button></a>
                            <a href="#deleteCustomerModal" class="delete" data-toggle="modal"><button onclick="deleteCustomer('${product.id}','${product.name}')" class="material-icons bg-danger" data-toggle="tooltip" title="" data-original-title="Edit">Del</button></a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
