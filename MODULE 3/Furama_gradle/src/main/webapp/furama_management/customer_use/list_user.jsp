    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            ...
            <table class="table table-striped table-hover" id="tableCustomeruser" style="width: 100%">
                ...
                <tbody>
                <c:forEach var="contract" items="${contracts}" varStatus="no">
                    <tr>
                        ...
                        <td>
                            <a href="/service?action=edit&name=${contract.nameService}" class="edit"><button class="material-icons bg-success" data-original-title="Edit">Edit Service</button></a>
                            <a href="#deleteContractModal" class="delete" data-toggle="modal"><button onclick="deleteService('${contract.id}')" class="material-icons bg-danger" data-toggle="tooltip" title="" data-original-title="Edit">Del Contract</button></a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
        ...
        <div class="modal-content">
            <form method="post" action="/contract?action=delete">
                ...
                <div class="modal-body">
                    ...
                    <p>Are you sure you want to delete these Records<span id=""></span>?</p>
