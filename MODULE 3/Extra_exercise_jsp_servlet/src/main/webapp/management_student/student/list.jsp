...
<header class="position-fixed w-100" style="top: 0">
    ...
    <nav class="navbar navbar-expand-sm bg-dark navbar-dark align-self-end justify-content-between">
        ...
        <form class="form-inline" action="/student?action=search" method="post">
        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    ...
                    <div class="col-sm-2">
                        <a href="/student?action=create" class="btn btn-success"><i class="material-icons"></i> <span>Add New Student</span></a>
                    </div>
                </div>
            </div>
            <table class="table table-striped table-hover" id="tableStudent" style="width: 100%">
                ...
                <tbody>
                <c:forEach var="student" items="${students}" varStatus="no">
                    <tr>
                        ...
                        <td>
                            <a href="/student?action=edit&id=${student.id}" class="edit"><button class="material-icons bg-success" data-original-title="Edit">Edit</button></a>
                            <a href="#deleteStudentModal" class="delete" data-toggle="modal"><button onclick="deleteStudent('${student.id}','${student.name}')" class="material-icons bg-danger" data-toggle="tooltip" title="" data-original-title="Edit">Del</button></a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
        ...
        <div class="modal-content">
            <form method="post" action="/student?action=delete">
                ...
                <div class="modal-body">
                    <input hidden name="id" id="idstudent" type="text">
                    <p>Are you sure you want to delete these Records with name is <span id="namestudent"></span>?</p>
