...
public class CustomerController {
    ...
    public ModelAndView saveCustomer(@ModelAttribute("customer") Customer customer) throws CustomerException {
    ...
    public ModelAndView updateCustomer(@ModelAttribute("customer") Customer customer) throws CustomerException {
        customerService.save(customer);
        ModelAndView modelAndView = new ModelAndView("/customer/edit");
